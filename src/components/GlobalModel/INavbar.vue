      ...
      <el-row justify="center">
        ...
        <el-col :span="7">
          ...
          <el-menu class="menu" mode="horizontal" :default-active="currentRoute">
            <el-menu-item index="/"><router-link class="link" to="/">首页</router-link></el-menu-item>
            <el-menu-item index="/questions"><router-link class="link" to="/questions">题库</router-link></el-menu-item>
            <el-menu-item index="/interview"><router-link class="link" to="/interview">面试</router-link></el-menu-item>
          </el-menu>
        </el-col>
        <el-col :span="6">
          <!-- 搜索栏 -->
